...
PhotoSwipe.propTypes = {
  ...
  options: _propTypes2.default.object, // eslint-disable-line
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentDidUpdate = function (prevProps) {
    ...
    if (!prevProps.isOpen && props.isOpen) {
      if (!isOpen) {
        _this3.openPhotoSwipe(props);
      } else {
        _this3.updateItems(props.items);
      }
    } else if (isOpen) {
  ...
  this.openPhotoSwipe = function (props) {
    ...
    _this3.photoSwipe = new _photoswipe2.default(pswpElement, _photoswipeUiDefault2.default, [].concat(_toConsumableArray(items)), options);
